var LucyWidget = (function () {
    return {
        ...
        createInterface: function (container, mainContainer) {
            ...
            // definition of questions associated with each button
            // definition of questions associated with each button
            var questionsMap = {
                'Academic Info': [
                    'What are PennAI\'s guiding principles and educational vision regarding artificial intelligence?',
                    'How does PennAI integrate theoretical advances into its research and teaching programs?',
                    'Which fundamental disciplines influence the development of PennAI\'s projects?',
                    'In what way does PennAI promote interdisciplinarity to enhance its approaches to artificial intelligence?'
                ],
                'Faculty': [
                    'What strategic partnership opportunities does PennAI offer to private sector players?',
                    'How does PennAI support innovation and the commercialization of AI technologies?',
                    'What collaborative models does PennAI propose to startups and investors in the field of AI?',
                    'How does PennAI measure the economic impact of its initiatives in the artificial intelligence market?'
                ],
                'Events': [
                    'What artificial intelligence applications is PennAI developing specifically for the healthcare sector?',
                    'How does PennAI collaborate with medical institutions to optimize diagnostics and treatments?',
                    'What research projects is PennAI undertaking to improve health data management?',
                    'How does PennAI integrate ethical criteria in the deployment of AI solutions in healthcare?'
                ],
                'Club/Orga.': [
                    'What innovative research methodologies does PennAI use to push the boundaries of AI?',
                    'How does PennAI scientifically validate the developed algorithms and models?',
                    'Which scientific fields does PennAI prioritize to guide its research work?',
                    'How does PennAI promote the integration of new technologies in the study of big data?'
                ],
                'Research': [
                    'How does PennAI assess the societal impact of artificial intelligence technologies?',
                    'What measures does PennAI implement to ensure ethical and responsible use of AI?',
                    'How does PennAI address challenges related to diversity and inclusion in its projects?',
                    'What initiatives does PennAI propose to raise public awareness of the societal issues surrounding AI?'
                ]
            };
