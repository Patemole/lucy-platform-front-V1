          ...
          {messages.length === 0 ? (
            <div className="flex-grow flex items-center justify-center w-full">
              <div className="w-full h-full p-8 bg-white flex flex-col items-center justify-center">
                <h1 className="text-4xl font-bold text-center mb-6 text-custom-blue">Your Assistant Lucy</h1>
                <div className="flex flex-col items-center space-y-4">
                  <Button variant="contained" style={{ borderRadius: '5px' }} color="primary">Based on verified data from upenn.edu</Button>
                  <Button variant="contained" style={{ borderRadius: '5px' }} color="primary">Which class can I take for next semester?</Button>
                  <Button variant="contained" style={{ borderRadius: '5px' }} color="primary">How many business models do you know?</Button>
                </div>
                <div className="flex justify-center mt-6 space-x-4">
                  <Button variant="outlined" color="primary">Gives us some feedbacks</Button>
                </div>
              </div>
            </div>
          ) : (
...
//Improvment 2.0 for the placehodler
/*
import React, { useState, useRef, KeyboardEvent, useEffect } from 'react';
import { useNavigate, useParams } from 'react-router-dom';
import { ThemeProvider, TextField, Button, Drawer, List, ListItem, ListItemIcon, ListItemText, Box, Typography, Menu, MenuItem, Avatar, Divider, IconButton, Snackbar, Alert } from '@mui/material';
              ...
              <TextField
                ...
                InputProps={{
                  ...
                  style: {
                    ...
                    color: theme.palette.text.primary,
                    borderRadius: '12px',
                    paddingRight: '40px', // Add padding to ensure text doesn't overlap with the send button
                  },
                }}
...
//improvment of the placholder for the message
/*
import React, { useState, useRef, KeyboardEvent, useEffect } from 'react';
import { useNavigate, useParams } from 'react-router-dom';
import { ThemeProvider, TextField, Button, Drawer, List, ListItem, ListItemIcon, ListItemText, Box, Typography, Menu, MenuItem, Avatar, Divider, IconButton, Snackbar, Alert } from '@mui/material';
...
//Modification du placholder pour contenir des messages plus long
/*
import React, { useState, useRef, KeyboardEvent, useEffect } from 'react';
import { useNavigate, useParams } from 'react-router-dom';
import { ThemeProvider, TextField, Button, Drawer, List, ListItem, ListItemIcon, ListItemText, Box, Typography, Menu, MenuItem, Avatar, Divider, IconButton, Snackbar, Alert } from '@mui/material';
...
//ajout de l'invisiblité du bouton contact advisor if the course_id is not == academic advisor -fonctionne 
/*
import React, { useState, useRef, KeyboardEvent, useEffect } from 'react';
import { useNavigate, useParams } from 'react-router-dom';
import { ThemeProvider, TextField, Button, Drawer, List, ListItem, ListItemIcon, ListItemText, Box, Typography, Menu, MenuItem, Avatar, Divider, IconButton, Snackbar, Alert } from '@mui/material';
...
//AJOUT POUR NAVIGATE VERS LA PAGE POUR CONTACTER SON ACADEMIC ADVISOR + TOUT LE RESTE - FONCTIONNE ET À JOUR
/*
import React, { useState, useRef, KeyboardEvent, useEffect } from 'react';
import { useNavigate, useParams } from 'react-router-dom';
import { ThemeProvider, TextField, Button, Drawer, List, ListItem, ListItemIcon, ListItemText, Box, Typography, Menu, MenuItem, Avatar, Divider, IconButton, Snackbar, Alert } from '@mui/material';
      ...
      <div className="flex h-screen bg-gray-100">
        ...
        <div className={`flex flex-col flex-grow transition-all duration-300 ${drawerOpen ? 'ml-60' : 'ml-0'}`}>
          <div className="relative p-4 bg-white flex items-center justify-between border-b border-gray-100">
            ...
            <Button variant="outlined" color="primary" onClick={handleMeetingClick}>Contact my Academic Advisor</Button>
          </div>
...
//NOUVELLE VERSION EN METTANT DANS UN AUTRE FICHIER LA GESTION DE LA POP-UP POUR RACCOURCIR LE CODE SUR CE FICHIER - FONCTIONNE
/*
import React, { useState, useRef, KeyboardEvent, useEffect } from 'react';
import { useNavigate, useParams } from 'react-router-dom';
import { ThemeProvider, TextField, Button, Drawer, List, ListItem, ListItemIcon, ListItemText, Box, Typography, Menu, MenuItem, Avatar, Divider, IconButton, Snackbar, Alert } from '@mui/material';
...
//DERNIER CODE A JOUR QUI FONCTIONNE - MANQUE SEULEMENT L'ENREGISTREMENT DU MESSAGE DANS UNE COLLECTION FIRESTORE
/*
import React, { useState, useRef, KeyboardEvent, useEffect } from 'react';
import { useNavigate, useParams } from 'react-router-dom';
import { ThemeProvider, TextField, Button, Drawer, List, ListItem, ListItemIcon, ListItemText, Box, Typography, Menu, MenuItem, Avatar, Divider, Modal, Backdrop, Fade, IconButton, Snackbar, Alert } from '@mui/material';
import SendIcon from '@mui/icons-material/Send';
import MenuIcon from '@mui/icons-material/Menu';
import MapsUgcRoundedIcon from '@mui/icons-material/MapsUgcRounded';
import HomeIcon from '@mui/icons-material/Home';
...
const Dashboard_eleve_template: React.FC = () => {
  ...
  const [lastValidCourseId, setLastValidCourseId] = useState<string | null>(null);
      ...
      if (uid) {
        ...
        if (userSnap.exists()) {
          ...
          if (validCourses.length > 0) {
            ...
            // Set the last valid course ID if it's not an allowed course ID
            if (!ALLOWED_COURSE_IDS.includes(initialCourseId)) {
              setLastValidCourseId(initialCourseId);
            }
          }
  ...
  const handleMenuClose = (option: string) => {
    ...
    if (selectedCourse) {
      ...
      if (ALLOWED_COURSE_IDS.includes(selectedCourse.id)) {
        ...
        setLastValidCourseId(selectedCourse.id);
      }
    }
    setAnchorEl(null);
  };
  ...
  const handleCloseModal = () => {
    // Revert to last valid course ID if the selected course ID is not allowed
    const currentCourseId = localStorage.getItem('course_id');
    if (ALLOWED_COURSE_IDS.includes(currentCourseId || '')) {
      setSelectedFilter(courseOptions.find(course => course.id === lastValidCourseId)?.name || '');
      localStorage.setItem('course_id', lastValidCourseId || '');
    }
    setModalOpen(false);
  };
      ...
      >
        <Fade in={modalOpen}>
          ...
          >
            ...
            <Typography sx={{ mt: 2 }} style={{ fontWeight: '500', fontSize: '0.875rem', color: theme.palette.text.primary }}>
...
//CODE QUI FONCTIONNE PARFAITEMENT MANQUE SEULEMENT LE RETOUR AU COURSE_ID AUTORISÉ/DISPONIBLE
/*
import React, { useState, useRef, KeyboardEvent, useEffect } from 'react';
import { useNavigate, useParams } from 'react-router-dom';
import { ThemeProvider, TextField, Button, Drawer, List, ListItem, ListItemIcon, ListItemText, Box, Typography, Menu, MenuItem, Avatar, Divider, Modal, Backdrop, Fade, IconButton, Snackbar, Alert } from '@mui/material';
...
const Dashboard_eleve_template: React.FC = () => {
  ...
  //this is the course_id for study abroad & career advisor
  const ALLOWED_COURSE_IDS = ["Connf4P2TpKXXGooaQD5", "tyPR1RAulPfqLLfNgIqF"];
...
//CODE QUI FONCTIONNE AVEC LE DESIGN - MANQUE LA SELECTION DES COURSES_ID
/*
import React, { useState, useRef, KeyboardEvent, useEffect } from 'react';
import { useNavigate, useParams } from 'react-router-dom';
import { ThemeProvider, TextField, Button, Drawer, List, ListItem, ListItemIcon, ListItemText, Box, Typography, Menu, MenuItem, Avatar, Divider, Modal, Backdrop, Fade, IconButton, Snackbar, Alert } from '@mui/material';
...
/*  CODE QUI FONCTIONNE RESTE LA PARTIE DESIGN
import React, { useState, useRef, KeyboardEvent, useEffect } from 'react';
import { useNavigate, useParams } from 'react-router-dom';
import { ThemeProvider, TextField, Button, Drawer, List, ListItem, ListItemIcon, ListItemText, Box, Typography, Menu, MenuItem, Avatar, Divider, Modal, Backdrop, Fade, IconButton, Snackbar, Alert } from '@mui/material';
import SendIcon from '@mui/icons-material/Send';
...
//VERSION ACCEPTABLE MAIS SANS LA SELECTION DES COURSE_ID 
/*
import React, { useState, useRef, KeyboardEvent, useEffect } from 'react';
import { useNavigate, useParams } from 'react-router-dom';
import { ThemeProvider, TextField, Button, Drawer, List, ListItem, ListItemIcon, ListItemText, Box, Typography, Menu, MenuItem, Avatar, Divider, Modal, Backdrop, Fade, IconButton } from '@mui/material';
import SendIcon from '@mui/icons-material/Send';
import MenuIcon from '@mui/icons-material/Menu';
import MapsUgcRoundedIcon from '@mui/icons-material/MapsUgcRounded';
import HomeIcon from '@mui/icons-material/Home';
...
//Premier essai de la popup
/*
import React, { useState, useRef, KeyboardEvent, useEffect } from 'react';
import { useNavigate, useParams } from 'react-router-dom';
import { ThemeProvider, TextField, IconButton, Button, Drawer, List, ListItem, ListItemIcon, ListItemText, Box, Typography, Menu, MenuItem, Avatar, Divider, Modal, Backdrop, Fade } from '@mui/material';
import SendIcon from '@mui/icons-material/Send';
import MenuIcon from '@mui/icons-material/Menu';
import MapsUgcRoundedIcon from '@mui/icons-material/MapsUgcRounded';
import HomeIcon from '@mui/icons-material/Home';
...
/*
//NOUVEAU CODE POUR AJOUTER DE LA COULEUR POUR LES COURSE_ID - FONCTIONNE 
import React, { useState, useRef, KeyboardEvent, useEffect } from 'react';
import { useNavigate, useParams } from 'react-router-dom';
...
/* ANCIENNE CODE QUI FONCTIONNE ET QUI EST EN PROD
import React, { useState, useRef, KeyboardEvent, useEffect } from 'react';
import { useNavigate, useParams } from 'react-router-dom';
import { ThemeProvider, TextField, IconButton, Button, Drawer, List, ListItem, ListItemIcon, ListItemText, Box, Typography, Menu, MenuItem, Avatar, Divider } from '@mui/material';
import SendIcon from '@mui/icons-material/Send';
