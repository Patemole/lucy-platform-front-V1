...
//AJOUT DE LA CRÉATION D'UN CHATSESSIONS DOCUMENT ATTACHÉ AU USER + D'UN COURSE_ID QUI SERA TOUJOURS LE ACADEMIC ADVISOR 
...
const allowedDomains = {
  ...
  // Add other subdomains and their allowed domains here
};
...
const getErrorMessage = (subdomain) => {
  const universityNames = {
    upenn: 'Upenn',
    harvard: 'Harvard',
    // Add other subdomains and their names here
  };
