...
import fetchUserData from '../api/fetchStudentsData'; // Function to fetch user data
...
const AdminDashboard: React.FC = () => {
  ...
  const [statisticsTimeFilter, setStatisticsTimeFilter] = useState<string>('Today');
  const [studentSignupTimeFilter, setStudentSignupTimeFilter] = useState<string>('Today');
  ...
  const handleStatisticsTimeFilterChange = (event: SelectChangeEvent<string>) => {
    setStatisticsTimeFilter(event.target.value);
  };

  const handleStudentSignupTimeFilterChange = (event: SelectChangeEvent<string>) => {
    setStudentSignupTimeFilter(event.target.value);
  };
